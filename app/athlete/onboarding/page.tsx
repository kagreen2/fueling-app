            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-slate-800/60 border border-slate-700 rounded-xl p-4">
                ...
                {!inbodyScanPreview && !inbodyData && (
                  <div className="flex gap-2">
                    <label className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-slate-700/50 hover:bg-slate-700 border border-dashed border-slate-600 hover:border-purple-500/50 rounded-lg cursor-pointer transition-all">
                      <svg className="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                      <span className="text-sm text-slate-300 font-medium">Take Photo</span>
                    ...
                    <label className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-slate-700/50 hover:bg-slate-700 border border-dashed border-slate-600 hover:border-purple-500/50 rounded-lg cursor-pointer transition-all">
                      ...
                      <span className="text-sm text-slate-300 font-medium">Photo Library</span>
                      <input type="file" accept="image/*" onChange={handleInBodyUpload} className="hidden" />
                    </label>
                  </div>
                )}
